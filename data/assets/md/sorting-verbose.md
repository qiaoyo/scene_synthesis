...
* **单位与坐标系 (Units & Coordinate System):**
  ...
  * **Up Axis:**Z
* **场景描述(Scene Describe):** 该场景展示了一个典型的小型工业分拣或上下料作业单元。该场景位于一个具有工业风格的室内空间，整体布局紧凑且功能导向明确。车间的空间格局呈现出半封闭的角落结构，墙面采用了浅色工业瓷砖贴面，上方均匀分布着数扇带有矩形格栅的采光窗，这种设计既保证了室内光线，也符合标准工业厂房的建筑特征。地面平整且具有极高的光泽度，能够清晰地倒映出上方设备的轮廓，暗示了其具备良好的防尘或抗静电涂层，符合精密作业环境的要求。在设备排布方面，整个作业单元由两大核心组件构成：一台安装在专用工作台上的工业协作机器人及一套平行的皮带输送装置。两者采取并列布局，形成了一个高效的直线型作业区。首先，位于画面中心偏左位置的是一台高性能的多轴工业协作机器人（Cobot）。该机器人机械臂采用了鲜明的橙色与黑色撞色设计，这种高对比度的色彩不仅具有现代工业美感，也在生产安全中起到警示作用。机械臂由多个精密关节连接，从其结构判断，这应是一台六轴联动机器人，具备极高的运动灵活性，能够实现复杂的空间轨迹运动。其末端执行器虽然未安装大型夹具，但预留了通用的法兰接口，可根据具体分拣任务安装吸盘、气动夹爪或视觉传感器。支撑这台机器人的是一座纯白色的重型精密实验台或光学平台。该工作台台面厚实，表面密布着规则的螺纹阵列孔，这种设计允许根据生产需求快速加固机器人底座或安装各类辅助工装模具。工作台的支撑结构采用了坚固的H型铸造框架，并配有四个可调节高度的水平支脚，确保了机器人在高速运动时的动态稳定性，减少震动对作业精度的影响。紧邻工作台右侧的是一套蓝色的中型皮带输送装置。该输送机框架由工业槽钢焊接而成，表面喷涂了耐磨的蓝色工业漆，整体结构稳固。输送带采用黑色高摩擦力合成材料，宽度约为50-60厘米，长度延伸至画面边缘，构成了一条完整的物料流转通道。输送带两侧设有防溢边框，动力装置位于输送末端，通过轴承座与驱动滚筒相连。输送机的支撑腿同样配备了可调地脚，确保其与机器人工作台保持在同一水平高度，便于物料在两者之间的顺畅交接。从整体规划结构来看，这是一个高度集中的自动化孤岛。机器人工作台与输送带之间的间距经过精确计算，正好处于机器人的最佳工作半径范围内。这种布局模式通常用于实现物料的自动化分拣：传送带将待处理的工件匀速送入机器人的抓取位，机器人通过传感器识别后，将其从传送带上拾取并放置到左侧的工作台上进行检测、组装或打标处理；反之，机器人也可以将加工完成的半成品从工作台精准地码放到传送带上，送往下一道工序。在该布局中，控制柜可能位于画面外侧或集成在设备底部。整个场景没有任何多余的杂物，体现了精益生产（Lean Production）的整洁与高效。设备之间的相互排布关系逻辑清晰：以机器人为中心，左侧为静态处理/放置区（工作台），右侧为动态物流区（输送带）。这种“中心辐射式”的作业规划，极大限度地缩短了机器人的运动轨迹，从而提高了单次分拣的循环效率（Cycle Time）。
* **设备数量(Device Number):**
  * **Scene: 1**
  * **IndustrialRobot: 1**
  * **Workbench: 1**
...
* **Prim类型 (Prim Type):**Xform
* **外部引用 (Referenced USD Files):**
  *   [reference] '../assets/Workbench_1/Workbench_1.usdc'
* **世界包围盒 (World BBox):**
  * Size: '(256.214, 149.882, 116.575)'
  * Center: '(0.413, -2.683, 0.769)'
...
* **Prim类型 (Prim Type):**Xform
* **外部引用 (Referenced USD Files):**
  *   [reference] '../assets/Black_Honey_-_Robotic_Arm/Black_Honey_-_Robotic_Arm.usdc'
* **世界包围盒 (World BBox):**
  * Size: '(0.808, 2.273, 0.363)'
  * Center: '(-0.599, -2.816, 2.554)'
...
### /World/Workbench_1/Materials/Color_D02

* **Prim路径 (Prim Path):**/World/Workbench_1/Materials/Color_D02
* **Prim类型 (Prim Type):**Material
* **材质网络 (Material & Shader Details):**
  * **Surface Outputs:**
    * 'outputs:surface' -> '/World/Workbench_1/Materials/Color_D02/pbr_shader'
    * Shader ID: 'UsdPreviewSurface'
    * Connection: 'surface' (Output)'
  * **Shader 节点 (Shader Nodes):**
    * '/World/Workbench_1/Materials/Color_D02/pbr_shader' (ID: 'UsdPreviewSurface')
    * Implementation: 'id'
    * Inputs:
      * 'diffuseColor' [color3f] = '(1.000, 0.898, 0.600)'
      * 'emissiveColor' [color3f] = '(0.000, 0.000, 0.000)'
      * 'metallic' [float] = '0'
      * 'normal' [normal3f] = '(0.000, 0.000, 1.000)'
      * 'occlusion' [float] = '1'
...
### /World/Workbench_1/Materials/Steel_Brushed_Stainless

* **Prim路径 (Prim Path):**/World/Workbench_1/Materials/Steel_Brushed_Stainless
* **Prim类型 (Prim Type):**Material
* **材质网络 (Material & Shader Details):**
  * **Surface Outputs:**
    * 'outputs:surface' -> '/World/Workbench_1/Materials/Steel_Brushed_Stainless/pbr_shader'
    * Shader ID: 'UsdPreviewSurface'
    * Connection: 'surface' (Output)'
  * **Shader 节点 (Shader Nodes):**
    * '/World/Workbench_1/Materials/Steel_Brushed_Stainless/pbr_shader' (ID: 'UsdPreviewSurface')
    * Implementation: 'id'
    * Inputs:
      * 'diffuseColor' [color3f]
        * Connected: '/World/Workbench_1/Materials/Steel_Brushed_Stainless/tex_base.outputs:rgb' @ '/World/Workbench_1/Materials/Steel_Brushed_Stainless/tex_base'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Steel_Brushed_Stainless_baseColor.jpg'
      * 'emissiveColor' [color3f] = '(0.000, 0.000, 0.000)'
      * 'metallic' [float] = '0'
      * 'normal' [normal3f] = '(0.000, 0.000, 1.000)'
      * 'occlusion' [float] = '1'
      * 'roughness' [float] = '0.6'
    * '/World/Workbench_1/Materials/Steel_Brushed_Stainless/tex_base' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Steel_Brushed_Stainless_baseColor.jpg'
    * Inputs:
      * 'fallback' [float4] = '(1.000, 1.000, 1.000, 1.000)'
      * 'file' [asset] = '0/Steel_Brushed_Stainless_baseColor.jpg'
      * 'st' [float2]
        * Connected: '/World/Workbench_1/Materials/Steel_Brushed_Stainless/uvset0.outputs:result' @ '/World/Workbench_1/Materials/Steel_Brushed_Stainless/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Workbench_1/Materials/Steel_Brushed_Stainless/uvset0' (ID: 'UsdPrimvarReader_float2')
    * Implementation: 'id'
