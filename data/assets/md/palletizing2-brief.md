...
* **单位与坐标系 (Units & Coordinate System):**
  ...
  * **Up Axis:**Z
* **场景描述(Scene Describe):** 该工业场景呈现为一个极具矩阵感的高密度自动化分拣车间，采用“多级并行、网格分布”的空间规划逻辑。地面铺设灰色大理石纹镜面地砖，墙面配有工业挂板与采光窗。核心设备由4至5条平行的银灰色金属架带式输送机组成，黑色皮带上密集排布着浅棕色标准纸箱。每条线末端及侧向分拨点均部署有大量白色长臂六轴机器人及明黄色AGV移动终端，形成了“一机多点”的矩阵式协作阵列。整体布局将输送机的长程运输、机器人的精密抓取与AGV的水平柔性调度交织为立体的分拣网络，极大提升了系统的冗余度与瞬时吞吐量。在3D合成中，该场景提供了极致的资产复用与几何对齐参考，材质上涵盖金属喷漆、半哑光漆面与石材纹理的多维对比，配合均匀的漫反射高空照明，是构建超大规模智慧物流中心数字孪生的理想专业参考素材。
* **设备数量(Device Number):**
  * **Scene: 1**
  * **IndustrialRobot: 16**
  * **Workbench: 0**
