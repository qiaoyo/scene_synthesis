...
* **单位与坐标系 (Units & Coordinate System):**
  ...
  * **Up Axis:**Z
* **场景描述(Scene Describe):** 该场景为规整模块化自动化装配单元，布局遵循线性物料流向、分区逻辑清晰。核心是一条长6–8米、宽600mm的重型直线皮带输送机，采用4080铝型材框架、黑色防滑抗静电皮带，配可调支撑地脚；输送线中段侧方布设两台六轴工业机器人+中央协作工作台的作业集群，机器人对称布局、带电控夹爪，分别处于抓取与待机姿态，作业范围全覆盖工位。中间集成控制柜式多层作业平台，作业高度850mm，造型规整、内置电控与走线结构。整体为标准封闭厂房环境，浅灰墙体配红色安全警示带；材质包含金属铝型材、哑光机器人漆面、耐磨环氧地坪，以工业灰、科技白为主色调，红色点缀；采用厂房LED均匀漫光照明，软阴影自然，适配3D工业场景合成建模使用。
* **设备数量(Device Number):**
  * **Scene: 1**
  * **IndustrialRobot: 2**
  * **Workbench: 1**
...
* BBox (world): size=(1.171, 1.898, 1.690), center=(14.808, 28.956, 0.952)
...
* 引用: payload:../assets/INDUSTRIAL_ROBOTIC_ARM/INDUSTRIAL_ROBOTIC_ARM.usdc
* BBox (world): size=(1.171, 1.898, 1.690), center=(15.127, 32.537, 0.952)
* 几何统计: Mesh=38, Vertices=45024, Faces=53168
