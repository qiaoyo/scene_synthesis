...
* **单位与坐标系 (Units & Coordinate System):**
  ...
  * **Up Axis:**Z
* **场景描述(Scene Describe):** 该码垛工位工业场景呈现为一个极具现代感的自动化仓储与末端包装作业区，其空间格局采用了“并行流向、多点协作”的平面规划结构，旨在实现纸箱类物料的高效搬运与堆叠。车间整体空间视野开阔，地面采用了高光泽度的白色环氧树脂地坪，具有极强的环境反射特性，能够清晰映射出设备底部的倒影，不仅提升了作业区的清洁感，也为视觉导航系统提供了良好的光学背景；墙面结构划分为上下两层，基部为带有仿古纹理的浅棕色砖墙装饰，上层则为浅青色的长方形方块砖饰面，这种色彩组合有效缓解了工业环境的冷峻感。在设备排布上，场景的核心由两台独立排布的短程带式输送机与与之配套的协作机器人集群构成。输送机采用鲜艳的工业蓝金属框架，其结构集成了竖向支撑立柱、加强型横梁及底部可调节的圆盘状防震地脚；输送带表面为纯黑色抗静电材质，其上整齐码放着四至五个已封口的浅棕色标准纸箱。这两台输送机呈阶梯状平行排布，形成了两条独立的物料输入/输出通道。紧邻输送机侧方，部署了两台白色六轴小型协作机器人，机器人底座垂直锚定于地面，关节处采用了亮黄色的模块化涂层进行识别。其中，左侧的机器人处于向地面堆垛区延伸的动态位姿，其末端执行器配备了二指平动电控夹爪，正准备对地面上的纸箱进行精准码放。区域划分明确，地面上分布着三个主要的纸箱堆叠区，每个区域均以金字塔状或阶梯状稳定堆叠着十余个纸箱，展现了典型的depalletizing（拆码垛）或palletizing（码垛）工艺流程。输送机、机器人与堆垛区之间的排布关系严格遵循了机械臂的工作包络线，确保了机器人能够以最短路径在输送带与地面堆叠点之间进行物料移载。整个场景的规划结构消除了冗余的围栏等物理屏障，体现了人机协作或全自主无人化作业的灵活性特征。在3D场景合成中，这种布局提供了极佳的几何对齐逻辑与资产重复率，材质上涵盖了蓝色喷漆金属、原色瓦楞纸、半哑光漆面机器人以及高反光地面的多维度视觉对比。光影环境设定为均匀的漫反射高空照明，配合地面的镜面反射效果，使场景具有极强的空间层次感与真实的物理着陆感，是构建自动化物流仓储数字孪生场景的理想专业参考样本。
* **设备数量(Device Number):**
  * **Scene: 1**
  * **IndustrialRobot: 2**
  * **Workbench: 0**
...
* **世界包围盒 (World BBox):**
  * Size: '(69.944, 52.115, 50.993)'
  * Center: '(-1.800, 5.958, 0.255)'

---

### /World/Robotic_Manipulator_low_poly_01

* **Prim路径 (Prim Path):**/World/Robotic_Manipulator_low_poly_01
* **Prim类型 (Prim Type):**Xform
* **外部引用 (Referenced USD Files):**
  *   [reference] '../assets/Robotic_Manipulator_low_poly/Robotic_Manipulator_low_poly.usdc'
* **世界包围盒 (World BBox):**
  * Size: '(1.174, 0.951, 0.727)'
  * Center: '(-2.823, 2.331, 0.678)'
...
### /World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand

* **Prim路径 (Prim Path):**/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand
* **Prim类型 (Prim Type):**Material
* **材质网络 (Material & Shader Details):**
  * **Surface Outputs:**
    * 'outputs:surface' -> '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/pbr_shader'
    * Shader ID: 'UsdPreviewSurface'
    * Connection: 'surface' (Output)'
  * **Shader 节点 (Shader Nodes):**
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/pbr_shader' (ID: 'UsdPreviewSurface')
    * Implementation: 'id'
    * Inputs:
      * 'diffuseColor' [color3f]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_base.outputs:rgb' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_base'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Robot_hand_baseColor.jpg'
      * 'emissiveColor' [color3f] = '(0.000, 0.000, 0.000)'
      * 'metallic' [float]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_metallic.outputs:r' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_metallic'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Robot_hand_metallicRoughness_metal.jpg'
      * 'normal' [normal3f]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_normal.outputs:rgb' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_normal'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Robot_hand_normal.jpg'
      * 'occlusion' [float]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_occlusion.outputs:r' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_occlusion'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Robot_hand_metallicRoughness_occl.jpg'
      * 'roughness' [float]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_roughness.outputs:r' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_roughness'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Robot_hand_metallicRoughness_rough.jpg'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_base' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Robot_hand_baseColor.jpg'
    * Inputs:
      ...
      * 'file' [asset] = '0/Robot_hand_baseColor.jpg'
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0' (ID: 'UsdPrimvarReader_float2')
    * Implementation: 'id'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_metallic' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Robot_hand_metallicRoughness_metal.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_normal' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Robot_hand_normal.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_occlusion' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Robot_hand_metallicRoughness_occl.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Robot_hand/tex_roughness' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Robot_hand_metallicRoughness_rough.jpg'
    * Inputs:
...
### /World/Robotic_Manipulator_low_poly_01/Materials/Stand

* **Prim路径 (Prim Path):**/World/Robotic_Manipulator_low_poly_01/Materials/Stand
* **Prim类型 (Prim Type):**Material
* **材质网络 (Material & Shader Details):**
  * **Surface Outputs:**
    * 'outputs:surface' -> '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/pbr_shader'
    * Shader ID: 'UsdPreviewSurface'
    * Connection: 'surface' (Output)'
  * **Shader 节点 (Shader Nodes):**
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/pbr_shader' (ID: 'UsdPreviewSurface')
    * Implementation: 'id'
    * Inputs:
      * 'diffuseColor' [color3f]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_base.outputs:rgb' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_base'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Stand_baseColor.jpg'
      * 'emissiveColor' [color3f]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_emissive.outputs:rgb' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_emissive'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Stand_emissive.jpg'
      * 'metallic' [float]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_metallic.outputs:r' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_metallic'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Stand_metallicRoughness_metal.jpg'
      * 'normal' [normal3f]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_normal.outputs:rgb' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_normal'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Stand_normal.jpg'
      * 'occlusion' [float]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_occlusion.outputs:r' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_occlusion'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Stand_metallicRoughness_occl.jpg'
      * 'roughness' [float]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_roughness.outputs:r' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_roughness'
          * Shader ID: 'UsdUVTexture'
          * Texture: '0/Stand_metallicRoughness_rough.jpg'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_base' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Stand_baseColor.jpg'
    * Inputs:
      ...
      * 'file' [asset] = '0/Stand_baseColor.jpg'
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0' (ID: 'UsdPrimvarReader_float2')
    * Implementation: 'id'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_emissive' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Stand_emissive.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_metallic' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Stand_metallicRoughness_metal.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_normal' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Stand_normal.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_occlusion' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Stand_metallicRoughness_occl.jpg'
    * Inputs:
      ...
      * 'st' [float2]
        * Connected: '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0.outputs:result' @ '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/uvset0'
          * Shader ID: 'UsdPrimvarReader_float2'
    * '/World/Robotic_Manipulator_low_poly_01/Materials/Stand/tex_roughness' (ID: 'UsdUVTexture')
    * Implementation: 'id'
    * 纹理引用 (Texture Assets):
      * '0/Stand_metallicRoughness_rough.jpg'
    * Inputs:
